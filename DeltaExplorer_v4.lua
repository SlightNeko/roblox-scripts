...
pcall(function()SG:SetCore("SendNotification",{Title="DeltaExplorer v4",Text="加载中",Duration=2})end)
...
m.Position=UDim2.new(0.5,-200,0.3,-150)
...
tb.BackgroundColor3=Color3.fromRGB(14,14,20)
...
tt.Text="DeltaExplorer v4"
tt.TextColor3=Color3.fromRGB(255,200,100)
tt.TextXAlignment=Enum.TextXAlignment.Left
tt.Font=Enum.Font.SourceSansBold
tt.TextSize=16
local cx=Instance.new("TextButton",tb)
cx.Size=UDim2.new(0,24,0,24)
cx.Position=UDim2.new(1,-28,0,3)
cx.BackgroundColor3=Color3.fromRGB(180,40,40)
cx.Text="X"
...
bar.BackgroundColor3=Color3.fromRGB(26,26,36)
...
for i=1,6 do
 ...
 tbs[i]=btn
 local pan=Instance.new("ScrollingFrame",m)
 pan.Size=UDim2.new(1,0,1,-58)
 pan.Position=UDim2.new(0,0,0,58)
 pan.BackgroundColor3=Color3.fromRGB(20,20,28)
 pan.BorderSizePixel=0
 pan.ScrollBarThickness=6
 pan.CanvasSize=UDim2.new(0,0,0,0)
 pan.AutomaticCanvasSize=Enum.AutomaticSize.Y
 pan.Visible=(i==1)
 tps[i]=pan
 local list=Instance.new("UIListLayout",pan)
...
local function L(pan,text,c)
 local lb=Instance.new("TextLabel",pan)
 lb.Size=UDim2.new(1,-10,0,22)
 lb.BackgroundTransparency=1
 lb.Text=text
 lb.TextColor3=c or Color3.fromRGB(200,200,200)
...
local function bt(pan,obj,depth,md)
 ...
 btn.Text=ind.."["..obj.ClassName.."] "..obj.Name
...
for _,cn in ipairs(vcs)do
 local btn=Instance.new("TextButton",vp)
...
local ib=Instance.new("TextBox",mp)
ib.Size=UDim2.new(1,-10,0,24)
ib.BackgroundColor3=Color3.fromRGB(30,30,40)
ib.TextColor3=Color3.fromRGB(200,200,200)
ib.PlaceholderText="workspace.Part"
ib.Text=""
ib.Font=Enum.Font.SourceSans
ib.TextSize=13
local ibCorner=Instance.new("UICorner",ib)
ibCorner.CornerRadius=UDim.new(0,6)
local sb=Instance.new("TextButton",mp)
sb.Size=UDim2.new(1,-10,0,24)
sb.BackgroundColor3=Color3.fromRGB(45,70,45)
sb.Text="开始"
...
local sb2=Instance.new("TextBox",sp)
sb2.Size=UDim2.new(1,-10,0,24)
sb2.BackgroundColor3=Color3.fromRGB(30,30,40)
sb2.TextColor3=Color3.fromRGB(200,200,200)
sb2.PlaceholderText="搜索内容..."
sb2.Text=""
sb2.Font=Enum.Font.SourceSans
sb2.TextSize=13
local sb2Corner=Instance.new("UICorner",sb2)
sb2Corner.CornerRadius=UDim.new(0,6)
local sbb=Instance.new("TextButton",sp)
sbb.Size=UDim2.new(1,-10,0,24)
sbb.BackgroundColor3=Color3.fromRGB(45,55,70)
sbb.Text="搜索"
sbb.TextColor3=Color3.fromRGB(200,200,200)
sbb.TextSize=13
sbb.Font=Enum.Font.SourceSans
sbb.AutoButtonColor=false
sbb.BorderSizePixel=0
local sbbCorner=Instance.new("UICorner",sbb)
sbbCorner.CornerRadius=UDim.new(0,6)
sbb.MouseButton1Click:Connect(function()
 ...
 for _,obj in ipairs(res)do
  ...
  btn.AutoButtonColor=false
  btn.BorderSizePixel=0
  local bCorner2=Instance.new("UICorner",btn)
...
local function lr(dir,cn,nm)
 local lb=Instance.new("TextLabel",rp)
 lb.Size=UDim2.new(1,-10,0,16)
 lb.BackgroundTransparency=1
 local dd=(dir=="S") and "发送" or dir
 lb.Text="["..dd.."] "..cn.." -> "..nm
 lb.TextXAlignment=Enum.TextXAlignment.Left
 lb.Font=Enum.Font.SourceSans
 lb.TextSize=11
...
-- Final
pcall(function()SG:SetCore("SendNotification",{Title="DeltaExplorer v4",Text="已加载",Duration=2})end)
